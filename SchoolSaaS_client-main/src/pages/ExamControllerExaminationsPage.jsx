...
import { Box, Container, Paper, Typography, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Button, Dialog, DialogTitle, DialogContent, DialogActions, TextField, MenuItem, Chip, ButtonGroup, IconButton } from '@mui/material';
...
export function ExamControllerExaminationsPage() {
  const { user } = useAuth();
